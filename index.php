...
<body>
    ...
    <!-- Barra Lateral -->
    <nav id="sidebar" class="sidebar d-flex flex-column align-items-start p-4 bg-dark text-white position-fixed" style="height: 100vh; width: 250px; border-radius: 0 15px 15px 0; box-shadow: 3px 0 10px rgba(0, 0, 0, 0.1);">
        <h2 class="h4 mb-4 text-center">Painel de Administração</h2>
    ...
    <button id="menu-toggle" class="navbar-toggler d-md-none" type="button" data-toggle="collapse" data-target="#sidebar" aria-controls="sidebar" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            // Alternar a visibilidade da barra lateral ao clicar no menu hambúrguer
            $('#menu-toggle').click(function () {
                $('#sidebar').toggleClass('d-none');
                $('#sidebar').toggleClass('d-md-block'); // Exibe a barra lateral novamente em telas médias ou grandes
            });
        });
    </script>
