    ...
    <div class="main-panel" style="margin-left: 250px;">
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <input class="form-control form-control-sm w-50" type="text" id="search" placeholder="Pesquisar...">
                    </div>
                    <div class="col-md-6 text-right">
                        <form class="d-flex" method="GET" action="">
                            <select class="form-control form-control-sm w-50" id="limit" onchange="searchData(1)">
